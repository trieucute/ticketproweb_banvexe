...
const BookTicketPageSingle  = () => {
    ...
    return (
        <div className='width-main'>
            ...
            <div className='routes-bus-container'>
            ...
            <div className='width-main-items my-5'>
                <div className='contents-items-choose'>
                    <div className='row'>
                            ...
                            <div className='items-contents'>
                                        ...
                                        <div className='row'>
                                            <div className='d-flex  justify-content-between  m-auto py-1'>
                                                <div className=' position-relative'>
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px"}}>A01</span> 
                                                </div>
                                                <div className=' position-relative'>
                                                    <svg width={43} height={33} viewBox="0 0 43 33" xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                                    ...
                                                    <span className='name-chair position-absolute' style={{fontSize:"0.6em", left:"13px",top:"3px"}}>A02</span> 
                                                </div>
                                            </div>
                                            <div className='d-flex  justify-content-between  m-auto py-1' >
                                                <div className=' position-relative'>
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px"}}>A03</span> 
                                                </div>
                                                <div className=' position-relative'>
                                                    <svg width={43} height={33} viewBox="0 0 43 33" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px"}}>A04</span> 
                                                </div>
                                                <div className=' position-relative'>
                                                    <svg width={43} height={33} viewBox="0 0 43 33" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px"}}>A05</span> 
                                                </div>
                                            </div>
                                            <div className='d-flex  justify-content-between  m-auto py-1' >
                                                <div className=' position-relative'>
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px"}}>A06</span> 
                                                </div>
                                                <div className=' position-relative'>
                                                    <svg width={43} height={33} viewBox="0 0 43 33" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px"}}>A07</span> 
                                                </div>
                                                <div className=' position-relative'>
                                                    <svg width={43} height={33} viewBox="0 0 43 33" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px"}}>A08</span> 
                                                </div>
                                            ...
                                            <div className='d-flex  justify-content-between  m-auto py-1' >
                                                <div className=' position-relative'>
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px"}}>A09</span> 
                                                </div>
                                                <div className=' position-relative'>
                                                    <svg width={43} height={33} viewBox="0 0 43 33" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px", color:"#E63946"}}>A10</span> 
                                                </div>
                                                <div className=' position-relative'>
                                                    <svg width={43} height={33} viewBox="0 0 43 33" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px", color:"#E63946"}}>A11</span> 
                                                </div>
                                            </div>
                                            <div className='d-flex  justify-content-between  m-auto py-1' >
                                                <div className=' position-relative'>
                                                <svg width={43} height={33} viewBox="0 0 43 33" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px", color:"#2E8A99"}}>A12</span> 
                                                </div>
                                                <div className=' position-relative'>
                                                    <svg width={43} height={33} viewBox="0 0 43 33" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px", color:"#2E8A99"}}>A13</span> 
                                                </div>
                                                <div className=' position-relative'>
                                                    <svg width={43} height={33} viewBox="0 0 43 33" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px", color:"#2E8A99"}}>A14</span> 
                                                </div>
                                            </div>
                                            <div className='d-flex  justify-content-between  m-auto py-1' >
                                                <div className=' position-relative'>
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px", color:"#2E8A99"}}>A15</span> 
                                                </div>
                                                <div className=' position-relative'>
                                                    <svg width={43} height={33} viewBox="0 0 43 33" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px", color:"#2E8A99"}}>A16</span> 
                                                </div>
                                                <div className=' position-relative'>
                                                    <svg width={43} height={33} viewBox="0 0 43 33" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px", color:"#2E8A99"}}>A17</span> 
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className='row'>
                                            <div className='d-flex  justify-content-between  m-auto py-1'>
                                                <div className=' position-relative'>
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px"}}>B01</span> 
                                                </div>
                                                <div className=' position-relative'>
                                                    <svg width={43} height={33} viewBox="0 0 43 33" xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                                    ...
                                                    <span className='name-chair position-absolute' style={{fontSize:"0.6em", left:"13px",top:"3px"}}>B02</span> 
                                                </div>
                                            </div>
                                            <div className='d-flex  justify-content-between  m-auto py-1' >
                                                <div className=' position-relative'>
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px"}}>B03</span> 
                                                </div>
                                                <div className=' position-relative'>
                                                    <svg width={43} height={33} viewBox="0 0 43 33" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px"}}>B04</span> 
                                                </div>
                                                <div className=' position-relative'>
                                                    <svg width={43} height={33} viewBox="0 0 43 33" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px"}}>B05</span> 
                                                </div>
                                            </div>
                                            <div className='d-flex  justify-content-between  m-auto py-1' >
                                                <div className=' position-relative'>
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px"}}>B06</span> 
                                                </div>
                                                <div className=' position-relative'>
                                                    <svg width={43} height={33} viewBox="0 0 43 33" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px"}}>B07</span> 
                                                </div>
                                                <div className=' position-relative'>
                                                    <svg width={43} height={33} viewBox="0 0 43 33" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px"}}>B08</span> 
                                                </div>
                                            ...
                                            <div className='d-flex  justify-content-between  m-auto py-1' >
                                                <div className=' position-relative'>
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px"}}>B09</span> 
                                                </div>
                                                <div className=' position-relative'>
                                                    <svg width={43} height={33} viewBox="0 0 43 33" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px", color:"#E63946"}}>B10</span> 
                                                </div>
                                                <div className=' position-relative'>
                                                    <svg width={43} height={33} viewBox="0 0 43 33" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px", color:"#E63946"}}>B11</span> 
                                                </div>
                                            </div>
                                            <div className='d-flex  justify-content-between  m-auto py-1' >
                                                <div className=' position-relative'>
                                                <svg width={43} height={33} viewBox="0 0 43 33" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px", color:"#2E8A99"}}>B12</span> 
                                                </div>
                                                <div className=' position-relative'>
                                                    <svg width={43} height={33} viewBox="0 0 43 33" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px", color:"#2E8A99"}}>B13</span> 
                                                </div>
                                                <div className=' position-relative'>
                                                    <svg width={43} height={33} viewBox="0 0 43 33" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px", color:"#2E8A99"}}>B14</span> 
                                                </div>
                                            </div>
                                            <div className='d-flex  justify-content-between  m-auto py-1' >
                                                <div className=' position-relative'>
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px", color:"#2E8A99"}}>B15</span> 
                                                </div>
                                                <div className=' position-relative'>
                                                    <svg width={43} height={33} viewBox="0 0 43 33" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px", color:"#2E8A99"}}>B16</span> 
                                                </div>
                                                <div className=' position-relative'>
                                                    <svg width={43} height={33} viewBox="0 0 43 33" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                    ...
                                                    <span className='name-chair position-absolute'  style={{fontSize:"0.6em", left:"13px",top:"3px", color:"#2E8A99"}}>B17</span> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className='items-Floor-des col-sm-4'>
                                        <div className='row mt-4'>
                                            ...
                                            <div className='item-des d-flex  my-2'>
                                                <span>
                                                    <svg width={15} height={15} viewBox="0 0 15 15"  xmlns="http://www.w3.org/2000/svg">
                                                        <circle cx="7.5" cy="7.5" r="7.5" fill="#2E8A99" fillOpacity="0.8" />
                                                    </svg>
                                                </span>
                                                <span className='ms-3'>
                                                Còn trống
                                            ...
                                            <div className='item-des d-flex my-2'>
                                                <span>
                                                    <svg width={15} height={15} viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
                                                        <circle cx="7.5" cy="7.5" r="7.5" fill="#E63946" fillOpacity="0.8" />
                                                    </svg>
                                                </span>
                                                <span className='ms-3'>
                                                Đang chọn
                                ...
                                <div className='Client-information-contents my-4  items-choose' id='step3'>
                                 ...
                                 <div className='d-flex align-items-center mt-5 submit-checkbox'>
                                    <input type="checkbox" style={{width:"15px", height:"15px", }}/><div className='text'><span className='ms-3' style={{color:"#E63946"}}>Chấp nhận điều khoản   </span> đặt vé & chính sách bảo mật thông tin của WebProTicket </div>
                                </div>
                        ...
                        <div className="col">
                            <div className="card">
                                ...
                                <div className="row mt-2">
                                    ...
                                    <div className="col text-end text-danger">19:35 10-08-2023</div>
                                </div>
                                <div className="row mt-2">
                                ...
                                <div className="row mt-2">
                                    ...
                                    <div className="col text-end text-danger">B10, B11, B14, B13</div>
                                </div>
                                <div className="row mt-2">
