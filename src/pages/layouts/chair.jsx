...
const ChairChoose= () => {
  const selectedChairsGo = useRef([]);
  const selectedChairsBack = useRef([]);
const nameChair = useRef([])
  const handleClick = (chair, selectedChairs, nameMobileChair) => {
    ...
    if (chair.isClicked) {
      // If the chair was clicked before
      path.style.fill = '';
      nameChair.style.color = '';
      chair.isClicked = false;
      const index = selectedChairs.current.indexOf(nameChair.innerHTML);
      if (index > -1) {
        selectedChairs.current.splice(index, 1);
      }
    } else {
      // If the chair was not clicked before
      path.style.fill = '#E63946';
      nameChair.style.color = '#E63946';
      chair.isClicked = true;
      selectedChairs.current.push(nameChair.innerHTML);
    }
    nameMobileChair= selectedChairs.current.join(', ');
    console.log('name',nameMobileChair);
// if(nameMobileChairGo){
//   nameMobileChairGo.innerText=nameMobileChair

// }
// if(nameMobileChairBack){
//   nameMobileChairBack.innerText=nameMobileChair

// }
  };

  const handleItemClickGo = (event, selectedChairs,nameChair) => {
    const chair = event.currentTarget;
    const nameMobileChair = document.getElementById('item-chair-chosen-go');
  
    handleClick(chair, selectedChairs, nameChair);
    
    nameMobileChair.innerText= nameChair
  };
  const handleItemClickBack = (event, selectedChairs) => {
    const chair = event.currentTarget;
    const nameMobileChair = document.getElementById('item-chair-chosen-back');
  
    handleClick(chair, selectedChairs, nameMobileChair);
    console.log(nameMobileChair);
  };
  return (
    <div>
                      ...
                      <div className="items-FloorDown col-sm-4 ">
                        ...
                        <div className="row">
                          ...
                          <div className="d-flex  justify-content-between  m-auto py-1">
                            ...
                            <div
                              className=" position-relative chair-item-go"         onClick={(event) => handleItemClickGo(event, selectedChairsGo, nameChair)}
                      ...
                      <div className="items-FloorDown col-sm-4 ">
                        ...
                        <div className="row">
                          ...
                          <div className="d-flex  justify-content-between  m-auto py-1">
                            ...
                            <div
                              className=" position-relative chair-item-back"         onClick={(event) => handleItemClickBack(event, selectedChairsBack)}
                              style={{ cursor: "pointer" }}
                            >
                              <svg
                                width={43}
